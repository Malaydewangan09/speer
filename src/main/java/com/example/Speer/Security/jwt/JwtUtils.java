package com.example.Speer.Security.jwt;
import io.jsonwebtoken.*;
import com.example.Speer.Security.services.UserDetailsImpl;
...
public class JwtUtils {
    ...
    @Value("${dealx.app.jwtSecret}")
    private String jwtSecret;

    @Value("${dealx.app.jwtExpirationMs}")
